            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Masuk untuk melanjutkan ke Marketplace Katering.</p>
                                    </div>
                                </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p>Belum memiliki akun ? <a href="/register" class="fw-medium text-primary">
                                    Daftar sekarang </a> </p>
                            <p>
                            <p>atau<a href="/register-merchant" class="fw-medium text-primary">
                                    Daftar sebagai Katering </a> </p>
                            <p>©
                                <script>
